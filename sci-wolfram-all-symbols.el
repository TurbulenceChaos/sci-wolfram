...
(defvar sci-wolfram-special-char nil "List of Wolfram Language named characters.")

(setq sci-wolfram-special-char
...
(defvar sci-wolfram-funs1 nil "List of Wolfram Language symbols. Part of many.")

(setq sci-wolfram-funs1
...
(defvar sci-wolfram-funs2 nil "List of Wolfram Language symbols. Part of many.")

(setq sci-wolfram-funs2
      '("E"
...
(defvar sci-wolfram-funs2-5 nil "List of Wolfram Language symbols. Part of many.")

(setq sci-wolfram-funs2-5
...
(defvar sci-wolfram-funs3 nil "List of Wolfram Language symbols. Part of many.")

(setq sci-wolfram-funs3
      '("N"
...
(defvar sci-wolfram-funs3-5 nil "List of Wolfram Language symbols. Part of many.")

(setq sci-wolfram-funs3-5
...
(defvar sci-wolfram-funs4 nil "List of Wolfram Language symbols. Part of many.")

(setq sci-wolfram-funs4
...
(defvar sci-wolfram-dollar-names nil "List of Wolfram Language symbols. Part of many.")

(setq sci-wolfram-dollar-names
      '("$Aborted"
...
(defcustom sci-wolfram-usr-funs '()
  "Add Additional Wolfram Language symbols."
  :type '(repeat string)
  :group 'sci-wolfram-mode)

(add-to-list 'sci-wolfram-usr-funs "D")
...
(setq sci-wolfram-all-symbols
      (append
       ...
       sci-wolfram-funs3-5
       sci-wolfram-funs4
       sci-wolfram-usr-funs
       sci-wolfram-dollar-names))
