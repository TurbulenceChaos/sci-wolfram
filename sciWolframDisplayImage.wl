...
sciWolframEnv = If[SameQ[Environment["TERM_PROGRAM"], "vscode"], "vscode" , "emacs"];
...
sciWolframImage[expr_, sciWolframImageDPI_, sciWolframImageName_, playNB_, sciWolframShortLines_] :=
        Module[{dir, sciWolframImageDir, filePNG, fileNB},
                ...
                filePNG = FileNameJoin[{sciWolframImageDir, StringTemplate["wolfram-`1`.png"][If[sciWolframImageName == "uuid", CreateUUID[], imgCount++]]}];
        ...
        Module[{box, isString, isPlot},
                ...
                Which[
                        isString,
                                Switch[sciWolframEnv,
                                        "emacs",
                                                If[SameQ[expr, Null], expr, sciWolframText[expr, OptionValue @ sciWolframShortLines]]
                                        ,
                                        "vscode",
                                                expr
                                ]
                                                ...
                                                Switch[OptionValue[sciWolframFormulaType],
                                                        ...
                                                        "image",
                                                                sciWolframImage[
                                                                        ...
                                                                        OptionValue[sciWolframImageDPI],
                                                                        OptionValue[sciWolframImageName],
                                                                        playNB = If[isPlot, OptionValue @ sciWolframPlay, "no"],
                                                                        OptionValue[sciWolframShortLines]
                                                                ]
                                                ]
                                        ,
